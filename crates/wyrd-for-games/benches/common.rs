...
use wyrd::{
    from_count, from_level, CalcOp, CompareOp, FlagPriority, KnotKind, Seed, Signal, TimerMode,
    ONE, ZERO,
};
...
/// Chamber-scale fixture used by the host-boundary benchmark.
pub fn shrine_chamber_weave() -> Weave {
    wyrd::weave! {
        id: "shrine-chamber";
        knots {
